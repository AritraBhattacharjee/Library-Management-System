...
def issue():
    ...
    try:
        ...
        msg.showinfo('Search Error',"The value entered is wrong, Try again.")
...
def issueBook():
    ...
    headingLabel = Label(headingFrame,text="Issue Book",bg="black",fg="white",font=("Courier",16))
